...
const AddUserForm = () => {
 ...
 if (files.length) {
  ...
  // Then create the user
      ...
      const { name, email, password, Firstname, Lastname, Date, Address, Telephone } = formData;

       const res = await createUser({name,email,password,Firstname,Lastname,Date,Address,Telephone, image: imageUrls})
       console.log(res)
  ...
  return (
    ...
    <Form onFinish={handleAction} ref={formRef} className="flex flex-col space-y-6">
