...
const extraAttributes = {
  label: "ฟิลด์ปุ่มกด",
  helperText: "วางข้อความช่วยเหลือที่นี่...",
  required: false,
};
    ...
    <Form {...form}>
      ...
      >
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                ส่วนหัวของฟิลด์ <br /> แสดงข้างบนของฟิลด์
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>ข้อความช่วยเหลือ</FormLabel>
              <FormControl>
                <Input
                  {...field}
                  onKeyDown={(e) => {
              ...
              <FormDescription>
                ข้อความช่วยเหลือของฟิลด์ <br />
                แสดงข้างล่างของฟิลด์
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
